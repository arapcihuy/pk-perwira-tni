// ============================================================
// FITUR 14 — v50: RUANG BELAJAR SAYA (akun berbasis kode, tanpa server)
//
// Permintaan pemilik: setiap pengguna punya tempat belajar sendiri dan
// bahan belajarnya tersimpan sendiri.
//
// Kenapa tanpa server: login sungguhan (akun + kata sandi) menuntut server,
// basis data, biaya bulanan, dan kewajiban pelindungan data pribadi (UU 27/2022).
// Yang dipakai di sini: KODE RUANG BELAJAR — kunci milik pengguna yang memuat
// seluruh datanya, bisa dipakai di perangkat lain, dan tidak dikirim ke mana pun.
//
// Bahan belajar yang disimpan: soal salah, catatan wawancara, gambar latihan,
// kartu hafalan, riwayat psikotes, log IQ, nilai tryout, laporan soal, statistik.
// ============================================================
...
function sisipPanel14() {
  ...
  // tautan ke ruang belajar dari halaman hasil kepribadian & profil
